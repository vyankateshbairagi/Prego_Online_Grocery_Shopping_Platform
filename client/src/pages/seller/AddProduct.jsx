  ...
  return (
    <div className="no-scrollbar flex-1 overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onSubmitHandler} className="w-full md:p-10 p-4 space-y-4 md:space-y-5 max-w-4xl mx-auto">
                <div>
                    <p className="text-sm md:text-base font-medium text-gray-800">Product Images</p>
                ...
                <div className="flex flex-col gap-1 w-full md:max-w-md">
                    <label className="text-sm md:text-base font-medium text-gray-800" htmlFor="product-name">Product Name</label>
                    <input onChange={(e)=> setName(e.target.value)} value={name}
                     id="product-name" type="text" placeholder="Enter product name" className="w-full outline-none md:py-2.5 py-2 px-3 rounded-lg border border-gray-300 focus:border-primary focus:ring-1 focus:ring-primary transition text-sm md:text-base" required />
                </div>
                <div className="flex flex-col gap-1 w-full md:max-w-md">
                    <label className="text-sm md:text-base font-medium text-gray-800" htmlFor="product-description">Product Description</label>
                    <textarea onChange={(e)=> setDescription(e.target.value)} value={description}
                     id="product-description" rows={4} className="w-full outline-none md:py-2.5 py-2 px-3 rounded-lg border border-gray-300 focus:border-primary focus:ring-1 focus:ring-primary transition resize-none text-sm md:text-base" placeholder="Enter product description"></textarea>
                </div>
                <div className="w-full flex flex-col gap-1 md:max-w-md">
                    <label className="text-sm md:text-base font-medium text-gray-800" htmlFor="category">Category</label>
                    {(() => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 w-full">
                    <div className="flex flex-col gap-1">
                        <label className="text-sm md:text-base font-medium text-gray-800" htmlFor="product-price">Product Price</label>
                    ...
                    <div className="flex flex-col gap-1">
                        <label className="text-sm md:text-base font-medium text-gray-800" htmlFor="offer-price">Offer Price</label>
                ...
                <button type="submit" className="w-full md:w-auto px-8 py-2.5 md:py-3 bg-primary hover:bg-primary-dull text-white font-medium rounded-lg cursor-pointer transition text-sm md:text-base">ADD PRODUCT</button>
            </form>
        </div>
  )
}
